...
const (
	...
	Friend_SetFriendBackground_FullMethodName = "/api.friend.v2.Friend/SetFriendBackground"
)
...
type FriendClient interface {
	...
	// 设置好友聊天背景图片
	SetFriendBackground(ctx context.Context, in *SetFriendBackgroundReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *friendClient) SetFriendBackground(ctx context.Context, in *SetFriendBackgroundReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Friend_SetFriendBackground_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FriendServer interface {
	...
	// 设置好友聊天背景图片
	SetFriendBackground(context.Context, *SetFriendBackgroundReq) (*emptypb.Empty, error)
...
func (UnimplementedFriendServer) SetFriendBackground(context.Context, *SetFriendBackgroundReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetFriendBackground not implemented")
}
...
func _Friend_SetFriendBackground_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetFriendBackgroundReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FriendServer).SetFriendBackground(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_SetFriendBackground_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FriendServer).SetFriendBackground(ctx, req.(*SetFriendBackgroundReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Friend_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetFriendBackground",
			Handler:    _Friend_SetFriendBackground_Handler,
		},
	},
