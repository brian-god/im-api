...
func IsUpdateFail(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == GroupErrorReason_UPDATE_FAIL.String() && e.Code == 521
}

// 更新错误
func ErrorUpdateFail(format string, args ...interface{}) *errors.Error {
	return errors.New(521, GroupErrorReason_UPDATE_FAIL.String(), fmt.Sprintf(format, args...))
}
...
func IsQueryFail(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == GroupErrorReason_QUERY_FAIL.String() && e.Code == 522
}
